...
// @route    GET api/expense-report/scatter-plot-report
// @desc     Plot scatter plot
// @access   Private
router.get("/expense-report/category", auth, async (req, res) => {
  return expenseController.getUserExpenseCategory(req, res);
});
...
// @desc     Show Dashboard
// @access   Private
router.get("/expense-report/dashboard", auth, async (req, res) => {
  console.log("re", req.body);
  return expenseController.getUserDashboard(req, res);
});
